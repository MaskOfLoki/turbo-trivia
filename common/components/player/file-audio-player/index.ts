...
export class FileAudioPlayer implements ClassComponent<IPlayerAttrs>, IPlayer {
  protected _element: HTMLAudioElement;
  ...
  public oncreate({ dom, attrs }: VnodeDOM<IPlayerAttrs>) {
    this._element = dom as HTMLAudioElement;

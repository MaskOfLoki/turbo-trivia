...
import { XCCountUp } from '@gamechangerinteractive/xc-components/shared/count-up';

export function template(this: AnimatedNumberComponent, { classNames, animation, txtColor }: IAnimatedNumberAttrs) {
  return (
    <div
    ...
    >
      {this.countUp && (
        <div
          ...
          style={{ animationDelay: this.delay + 'ms', animationDuration: this.duration + 'ms', color: txtColor }}
        >
          <XCCountUp
            startValue={0}

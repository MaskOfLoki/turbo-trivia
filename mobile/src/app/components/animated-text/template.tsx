...
export function template(this: AnimatedTextComponent, { classNames, animation }: IAnimatedTextAttrs) {
  return (
    <div
    ...
    >
      {this.letters.map((letter, i) => (
        <div
          ...
          style={{ animationDelay: this.letterDelay * i + this.delay + 'ms', animationDuration: this.duration + 'ms' }}
        >
          {letter}
        </div>
      ))}
